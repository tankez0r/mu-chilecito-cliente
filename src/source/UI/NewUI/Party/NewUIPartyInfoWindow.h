...
namespace SEASON3B
{
    ...
    public:
        enum IMAGE_LIST
        {
            ...
            IMAGE_PARTY_EXIT,										// newui_Party_x.tga			(13, 26)	// �ӽ�
        };
    ...
    private:
        ...
        // Exit Button
        CNewUIButton				m_BtnExit;							// ��Ƽâ �������ư
        CNewUIButton				m_BtnPartyExit[MAX_PARTYS];			// ��ƼŻ���ư

        int							m_iSelectedCharID;		// Party List���� ĳ���� ID�� ���� (default : -1)
    ...
    public:
        ...
        bool LeaveParty(const int iIndex);	// ��Ƽ���� ������ ����
